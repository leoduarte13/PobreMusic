...
export interface Track {
  nome_musica:string; nome_artista:string; duracao_ms?:number; album?:string; capa?:string; spotify_id?:string; videoId?:string;
  audioUrl?:string; previewUrl?:string;
  isLoadingVideo?:boolean; hasError?:boolean;
}
...
export interface TrackSearchResult { nome_musica:string; nome_artista:string; duracao_ms?:number; album?:string; capa?:string; spotify_id?:string; videoId?:string; audioUrl?:string; previewUrl?:string; origem?:string; }
