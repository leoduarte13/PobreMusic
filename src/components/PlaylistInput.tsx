...
import { SpotifyUser, UserPlaylistSummary, SavedPlaylist } from "../types";
      ...
      <div className="flex flex-col gap-2.5 pb-2.5 border-b border-zinc-800/70">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5 pt-1">
          ...
          >
            ...
            <span className="truncate">Minhas Playlists</span>
          ...
          >
            ...
            <span className="truncate">Nuvem (Salvas)</span>
            ...
            <form onSubmit={handleSubmit} className="flex items-center gap-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  placeholder="Cole o link ou ID do Spotify..."
                  disabled={isLoading}
            ...
            <div>
              {!spotifyUser ? (
                ...
                <div className="py-4 text-center text-zinc-400 space-y-1.5">
                  ...
                  <p className="text-xs">Sincronizando playlists...</p>
                </div>
              ) : userPlaylists.length === 0 ? (
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between gap-2">
                <span className="text-[11px] text-zinc-400 font-medium">
                  {savedPlaylists.length} playlists salvas no dispositivo
                </span>
                {onOpenCreateModal && (
                  <button
                    type="button"
                    onClick={onOpenCreateModal}
                    className="h-8 px-2.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-[11px] font-bold text-white flex items-center gap-1 shadow-sm"
                  >
              ...
              {savedPlaylists.length === 0 ? (
                <div className="p-4 rounded-xl bg-zinc-950/60 border border-zinc-800 text-center space-y-1">
                  <p className="text-xs text-zinc-400">Nenhuma playlist salva ainda.</p>
                </div>
              ) : (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 max-h-48 overflow-y-auto pr-1">
